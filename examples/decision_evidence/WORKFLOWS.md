...
flowchart TD
  ...
  subgraph assessment["assessment"]
    direction TB
    assessment__assess{{"assess<br/>decision · choice, multiselect, predicate, ordinal, request…"}}
  end
  outcome_completed__(["completed"])
  outcome_needs_review__(["needs_review"])
  start__ --> assessment
  assessment --> outcome_completed__
  assessment -.->|"review"| outcome_needs_review__
  classDef decision fill:#fff4e5,stroke:#d68a1d,color:#1f2328
  classDef flow fill:#fafbfc,stroke:#9aa1ab,color:#1f2328
  classDef terminal fill:#ffffff,stroke:#57606a,color:#1f2328
  class assessment__assess decision
  class assessment flow
...
flowchart TD
  ...
  subgraph assessment["assessment"]
    direction TB
    assessment__assess{{"assess<br/>decision · predicate"}}
  end
  outcome_completed__(["completed"])
  outcome_needs_review__(["needs_review"])
  start__ --> assessment
