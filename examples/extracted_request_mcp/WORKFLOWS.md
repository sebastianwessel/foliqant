...
flowchart TD
  ...
  subgraph extract["extract"]
    direction TB
    extract__extract(["extract<br/>llm"])
  end
  ...
  start__ --> extract
  extract --> lookup
  extract -.->|"review"| outcome_needs_review__
