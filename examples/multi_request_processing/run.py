"""Plan independent public-office requests and combine their prepared results."""
...
from examples.multi_request_processing import offline
...
DEMO_PAYLOAD: dict[str, JsonValue] = {
    "message": "Check FOI-2026-0142 and explain how to apply.",
    "language": "en",
}
...
async def run_example(payload: dict[str, JsonValue], *, live: bool = False) -> ExecutionResult:
    async with open_example(live=live) as app:
        return await app.run("intake", Envelope(payload=payload))
